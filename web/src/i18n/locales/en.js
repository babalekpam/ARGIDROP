export default {
  ...
  landing: {
    eyebrow: 'ARGILETTE Marketplace · ECOWAS Delivery Platform',
    headline1: 'Business moves.',
    headlineBrand: 'ArgiDrop',
    headline2: 'delivers.',
    subhead: 'Post a delivery. A verified driver nearby accepts. Track it live. Payment releases automatically when the package arrives. Built for businesses across West Africa.',
    ctaPost: 'Post your first delivery',
    ctaDriver: 'Become a driver →',
    stats: {
      avgMatch: 'Average time to match a driver',
      qrChain: 'QR-verified chain of custody per delivery',
    },
    process: {
      eyebrow: 'The process',
      title1: 'Three steps,',
      title2: 'from post to proof.',
      chapter: 'Chapter',
    ...
    markets: {
      ...
      title: 'Built for the ECOWAS market',
      desc: 'Mobile money native — MTN MoMo, Orange Money, Wave, T-Money, Moov. Multi-currency: XOF, GHS, NGN. French and English throughout. Pilot launching in Lomé, Togo.',
      bigNumber: '6',
      bigLabel: 'ECOWAS markets at launch',
    },
    driverCta: {
      eyebrow: 'Drivers',
