export default {
  ...
  home: {
    title: 'Welcome to ArgiDrop',
    subtitle: 'Order food, shop from local merchants, or book a ride — all in one place.',
    loadFailed: 'Could not load. Please try again.',
    actionFood: 'Order food',
    actionFoodDesc: 'Restaurants near you',
    actionShops: 'Shop',
    actionShopsDesc: 'Local merchants & stores',
    actionRide: 'Book a ride',
    actionRideDesc: 'Moto, zémidjan or car',
    restaurantsTitle: 'Restaurants',
    shopsTitle: 'Shops & merchants',
    seeAll: 'See all',
    closed: 'Closed',
    noRestaurants: 'No restaurants available yet. Check back soon!',
    noShops: 'No shops available yet. Check back soon!',
    rideTitle: 'Book a ride',
    rideSubtitle: 'Tell us where to pick you up and where you are going. Pay cash at the end of the ride.',
    rideFrom: 'Pickup location',
    rideTo: 'Destination',
    rideVehicle: 'Vehicle type',
    vehicle: { MOTO: 'Moto', ZEMIDJAN: 'Zémidjan', CAR: 'Car', TRICYCLE: 'Tricycle' },
    estimating: 'Calculating price…',
    ridePrice: 'Estimated price',
    rideDistance: 'Distance',
    rideDrivers: 'Drivers available',
    rideNoDrivers: 'No drivers are online right now — you can still book and we will match you as soon as one connects.',
    rideBook: 'Book this ride',
    booking: 'Booking…',
    rideBookedMatched: 'Ride booked! A driver is on the way.',
    rideBookedSearching: 'Ride booked! Searching for a driver…',
    payCash: 'Pay cash',
  ...
  food: {
    ...
    emptyBody: 'Restaurants are joining ArgiDrop Food soon. Check back shortly!',
    closed: 'Closed',
    closedNow: 'This restaurant is currently closed',
    featured: 'Featured',
    min: 'Min.',
    restaurant: 'Restaurant',
    notFound: 'Restaurant not found',
    backToList: 'All restaurants',
    noMenu: 'This restaurant has not published a menu yet.',
    popular: 'Popular',
    add: 'Add',
    ...
    total: 'Total',
    minWarning: 'Minimum order is {{amount}} XOF',
    checkout: 'Checkout',
    ...
    notesPlaceholder: 'Gate code, landmark… (optional)',
    codNote: 'Pay cash on delivery',
    cashOnDelivery: 'Cash on delivery',
    placing: 'Placing order…',
    placeOrder: 'Place order — {{amount}} XOF',
    orderFailed: 'Could not place the order',
    loadFailed: 'Could not load. Please try again.',
    orderPlaced: 'Order placed!',
    orderPlacedBody: '{{name}} has received your order. A driver will deliver it to you.',
    orderNumber: 'Order number',
    payment: 'Payment',
    noOrders: 'No orders yet',
    noOrdersBody: 'Your food orders will appear here.',
    status: {
      PENDING: 'Pending',
      CONFIRMED: 'Confirmed',
      PREPARING: 'Preparing',
