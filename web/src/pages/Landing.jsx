        ...
        <div className="download-row" style={{ background:C.paper, border:`1px solid ${C.border}`, borderRadius:8, padding:'40px 48px', display:'flex', gap:40, alignItems:'center' }}>
          ...
          <div className="download-text" style={{ flex:1, textAlign:'left' }}>
            ...
            <div className="download-badges" style={{ display:'flex', gap:12, flexWrap:'wrap' }}>
              <a href="https://apps.apple.com/app/id6764177430" target="_blank" rel="noopener noreferrer" aria-label="Download on the App Store" style={{ display:'inline-flex', alignItems:'center', gap:10, background:'#000', color:'#fff', padding:'10px 18px', borderRadius:8, textDecoration:'none', fontFamily:'inherit' }}>
                ...
                <span style={{ display:'flex', flexDirection:'column', lineHeight:1.05 }}>
                  <span style={{ fontSize:9, opacity:0.75, letterSpacing:'0.05em' }}>{t('landing.app.iosTop', "TÉLÉCHARGER SUR")}</span>
                  <span style={{ fontSize:15, fontWeight:600 }}>App Store</span>
                </span>
              </a>
              <a href="https://play.google.com/store/apps/details?id=com.argilette.argidrop.driver" target="_blank" rel="noopener noreferrer" aria-label="Get it on Google Play" style={{ display:'inline-flex', alignItems:'center', gap:10, background:'#000', color:'#fff', padding:'10px 18px', borderRadius:8, textDecoration:'none', fontFamily:'inherit' }}>
                ...
                <span style={{ display:'flex', flexDirection:'column', lineHeight:1.05 }}>
                  <span style={{ fontSize:9, opacity:0.75, letterSpacing:'0.05em' }}>{t('landing.app.androidTop', "DISPONIBLE SUR")}</span>
