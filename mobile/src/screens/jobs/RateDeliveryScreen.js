  ...
  return (
    <View style={{ flex:1, backgroundColor:C.cream }}>
      <View style={s.header}>
        ...
        <Text style={s.title}>Rate this delivery</Text>
        {businessName && <Text style={s.subtitle}>How was your experience with {businessName}?</Text>}
      </View>
      ...
      <View style={s.card}>
        ...
        <View style={{ marginTop:20 }}>
          ...
          <TextInput
            ...
            placeholder="Package was ready on time, instructions were clear…"
        ...
        <TouchableOpacity style={s.btnSkip} onPress={() => navigation.replace('DriverTabs')}>
